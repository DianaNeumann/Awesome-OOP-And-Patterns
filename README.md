 #  Экзамен (будут и остальные билеты, и реализации всех паттернов, не ссыте :) )
...
>
> При гуглёжке вы также можете встретить **Table Data Gateway** - он же **DAO (Data Access Object)** - ЭТО ДРУГОЕ, отношение к Gateway'ю, о котором мы говорим у него нет, это просто один из подходов организации работы с БД, его основное предназначение - спрятать SQL как деталь реализации, предоставив простой CRUD интерфейс для работы с таблицами в соответствии с нуждами приложения.
